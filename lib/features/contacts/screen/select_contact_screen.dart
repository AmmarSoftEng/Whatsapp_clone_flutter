...
class SelectContactsScreen extends ConsumerWidget {
  ...
  void selectC(WidgetRef ref, Contact contect, BuildContext context) {
    ref.read(contactControllerProvider).selectContect(contect, context);
  }
